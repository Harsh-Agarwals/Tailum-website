...
export default function Footer() {
  return (
    <div  className='flex flex-1 flex-col gap-4 sm:flex-row justify-between py-6 px-8 bg-[#0D021B] text-sm text-slate-200 tracking-wide'>
      ...
      <p>Made with ❤️ by <a href="www.fusionlabs.co.in" target='blank' className='tracking-wider'><span className='text-sky-400'>Fusion</span><span className='text-blue-600'>Labs</span></a></p>
    </div>
  )
}
