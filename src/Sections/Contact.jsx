  ...
  return (
    <div id='contact' className=' px-8 pt-10 pb-6 flex flex-1 flex-col items-center sm:flex-row flex-wrap gap-4 sm:gap-8 justify-between sm:items-start lg:justify-around md:mx-12 lg:mx-28'>
      <div className="message-us flex flex-1 flex-col items-center">
        ...
        <input type="email" name="user_email" id="user_email" placeholder='Your Email' className=' my-2 px-2 py-1 font-mono text-sm outline-red-800 text-slate-600 rounded-md w-full max-w-[270px]' required />
        <textarea name="user_msg" id="user_msg" cols="30" rows="5" placeholder='Your message...' className=' max-w-[270px] px-2 py-1 font-mono text-sm outline-red-800 text-slate-500 rounded-md' required></textarea>
      ...
      <div className="social-media flex flex-1 flex-col">
        ...
        <div className="contact-lists md:text-center pt-4">
            ...
            <p className=' tracking-wide text-amber-700 text-sm'><span className=' font-semibold text-amber-900'>Addesss: </span><span className='hover:text-amber-600'>Plot number - 12, Main road, Kosabadi, Korba: 495677, Chhattisgarh</span></p>
        </div>
