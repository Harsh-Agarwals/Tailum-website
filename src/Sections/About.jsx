  ...
  return (
    <div className='px-8 py-16 flex flex-1 flex-col items-center justify-center gap-12 sm:gap-4 sm:flex-row'>
      <div className="about sm:max-w-[60%]">
        ...
        <a href="https://www.amazon.in/dp/B0CTD2P7MN" className='py-[6px] px-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-md text-white font-semibold tracking-wide'>Buy Now</a>
      </div>
      <div className="image">
